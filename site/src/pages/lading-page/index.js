        ...
        <main className="principal">
            ...
            <section className="faixa-3">
                ...
                a se valorizarem mais.  Com 10 anos de profissão e mais de 2 milhões de seguidores no instagram, ela faz vídeos curtos com conselhos e também tem um podcast.' fala='Quero ajudar aqueles que não podem chegar até nós, seja por questões financeiras ou falta de acesso, pois saúde mental e autoestima deveriam ser acessíveis para todos.' rede='@amandafitas' />
                    <Pscologos psicologo='/assets/images/anili.jpg' nome='Anili Mancuzo' descricao='Psicóloga, encoraja mulheres a serem independentes emocionalmente, com foco em relacionamentos.' fala='Quero ajudar a mulheres, para que digam não ao relacionamento abusivo, e que consigam ser felizes apenas com a própria companhia, sem depender de alguém tóxico.' rede='@psicologaanilimancuzo' />
                    <Pscologos psicologo='/assets/images/luciene.jpeg' nome='Luciene Lacerda' descricao='Luciene Lacerda é psicóloga e coordena o Laboratório de Ética nas Relações de Trabalho e Educação (Laberte) e a Comissão de Direitos Humanos de Combate às Violências na Universidade Federal do Rio de Janeiro (UFRJ). Em 2016, ela deu os primeiros passos para criar a Campanha 21 Dias de Ativismo Contra o Racismo.' fala='“O que fazemos é juntar as várias formas de ativismo contra o racismo. O que nos orienta é a fala de Angela Davis: “não basta não ser racista; é preciso ser antirracista”.' />
                </Carousel>
            </section>
            ...
            <section className="faixa-7">
                ...
                <div className="integrantes">
                    ...
                    <Equipe className='integrante-4' integrante='/assets/images/image 21.png' nome='Eduardo Cesar' função='Full-Stack' />
                    <Equipe className='integrante-5' integrante='/assets/images/image 20.png' nome='Victor de Paula' função='Back-End' />
                </div>
